...
final class CaculatingClotherDiscountTest: XCTestCase, CaculatingClotherDiscount {
    ...
    func test_case1() {
        // act
        let result = self.getDiscount(clothers: [ClotherOrderItem(total: 4, type: .whiteShirt),
    ...
    func test_case3() {
        // act
        let result = self.getDiscount(clothers: [ClotherOrderItem(total: 0, type: .whiteShirt),
                                                 ClotherOrderItem(total: 0, type: .tie),
    ...
    func test_case4() {
        // act
        let result = self.getDiscount(clothers: [ClotherOrderItem(total: 1, type: .whiteShirt),
